"""
Django settings for VisionEye project.
"""
import os
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY", "visioneye-insecure-m4-silicon-key-secret-key-3918489"
)
...
# In-memory channel layers for real-time WebSocket communication
CHANNEL_LAYERS = {
    "default": {
...
# Database (lightweight SQLite for configuration / metadata if needed)
DATABASES = {
    "default": {
...
# File & Video Upload Limits (Supports 4K/HD video uploads up to 500MB)
